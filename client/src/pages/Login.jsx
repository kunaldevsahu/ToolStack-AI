  ...
  return (
    <div className="min-h-screen flex bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-indigo-500/10 rounded-full blur-[128px]" />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-purple-500/10 rounded-full blur-[128px]" />
      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center relative">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-6 pt-4">
            {['Humanizer', 'Summarizer', 'Rewriter'].map((tool) => (
              <span key={tool} className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/5 text-xs text-gray-400">
                {tool}
              </span>
            ))}
          </div>
